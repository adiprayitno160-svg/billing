...
export class BookkeepingService {
     ...
     */
    static async getUnpaidInvoices(startDate?: string, endDate?: string): Promise<any[]> {
     ...
     * Get paid invoices
     */
    static async getPaidInvoices(startDate?: string, endDate?: string): Promise<any[]> {
        const conn = await databasePool.getConnection();
        try {
            let query = `
                SELECT 
     ...
     */
    static async getBookkeepingData(startDate?: string, endDate?: string): Promise<BookkeepingData> {
        try {
     ...
     */
    static async getInvoicePayments(invoiceId: number): Promise<any[]> {
        const conn = await databasePool.getConnection();
        try {
