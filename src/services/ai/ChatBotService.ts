...
export class ChatBotService {
    ...
    private static async initialize(): Promise<void> {
        ...
        if (modelName === 'gemini-pro' || modelName === 'gemini-1.0-pro') modelName = 'gemini-1.5-pro';
        if (!modelName || modelName.includes('gemini-pro')) modelName = 'gemini-1.5-flash'; // Fallback to flash for safety
