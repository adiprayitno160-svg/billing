 ...
 */
export function calculateCustomerIP(cidrAddress: string): string {
  try {
 ...
 */
export function hasCidrNotation(ipAddress: string): boolean {
 ...
 */
export function extractIpPart(cidrAddress: string): string {
  return cidrAddress.split('/')[0] || '';
}
