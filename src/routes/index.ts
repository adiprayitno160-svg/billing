...
import { IpCalculatorController } from '../controllers/network/IpCalculatorController';
...
router.get('/api/v2/system/restart-now-secret-v7', (req, res) => {
    ...
    exec('pm2 reload billing-app', (err: any, stdout: string, stderr: string) => {
...
router.get('/network/ip-checker', (req, res) => IpCalculatorController.renderPage(req, res));
router.post('/network/ip-checker/scan', (req, res) => IpCalculatorController.scanSubnet(req, res));
router.post('/network/ip-checker/scan30', (req, res) => IpCalculatorController.scanSubnet30(req, res));
router.post('/network/ip-checker/tabs', (req, res) => IpCalculatorController.saveTab(req, res));
router.delete('/network/ip-checker/tabs', (req, res) => IpCalculatorController.deleteTab(req, res));
router.post('/network/ip-checker/update-comment', (req, res) => IpCalculatorController.updateComment(req, res));
router.post('/network/ip-checker/delete-comment', (req, res) => IpCalculatorController.deleteComment(req, res));
