...
export async function postStaticIpPackageUpdate(req: Request, res: Response, next: NextFunction) {
	try {
		...
		await updateStaticIpPackage(id, {
			...
			parent_download_name,
			max_limit_upload,
			limit_at_upload: limit_at_upload || null,
			max_limit_download,
			limit_at_download: limit_at_download || null,
			max_clients: max_clients ? Number(max_clients) : undefined,
			child_upload_name: child_upload_name || null,
			child_download_name: child_download_name || null,
			child_upload_limit: child_upload_limit || null,
			child_download_limit: child_download_limit || null,
			child_limit_at_upload: child_limit_at_upload || null,
			child_limit_at_download: child_limit_at_download || null,
			child_burst_upload: enable_burst === 'on' ? (child_burst_upload || null) : null,
			child_burst_download: enable_burst === 'on' ? (child_burst_download || null) : null,
			child_queue_type_download: child_queue_type_download || null,
			child_queue_type_upload: child_queue_type_upload || null,
			child_priority_download: child_priority_download || null,
			child_priority_upload: child_priority_upload || null,
			child_burst_threshold_download: enable_burst === 'on' ? (child_burst_threshold_download || null) : null,
			child_burst_threshold_upload: enable_burst === 'on' ? (child_burst_threshold_upload || null) : null,
			child_burst_time_download: enable_burst === 'on' ? (child_burst_time_download || null) : null,
			child_burst_time_upload: enable_burst === 'on' ? (child_burst_time_upload || null) : null,
