...
exports.TechnicianCleanupService = void 0;
const pool_1 = require("../../db/pool");
const node_cron_1 = __importDefault(require("node-cron"));
class TechnicianCleanupService {
    /**
    ...
    static async cleanupOldJobs() {
        try {
            ...
            const [result] = await pool_1.databasePool.query(`DELETE FROM technician_jobs 
...
exports.TechnicianCleanupService = TechnicianCleanupService;
//# sourceMappingURL=TechnicianCleanupService.js.map