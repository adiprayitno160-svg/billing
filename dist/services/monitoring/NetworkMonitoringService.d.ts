...
export declare class NetworkMonitoringService {
     ...
     */
    static getNetworkTopologyFast(): Promise<TopologyData>;
    /**
     ...
     */
    static getTroubleCustomers(notify?: boolean): Promise<any[]>;
    /**
     * Get previous customer states for recovery detection
     */
    private static getPreviousCustomerStates;
    /**
     * Update customer states for next comparison
     */
    private static updateCustomerStates;
    /**
     * Enhanced timeout detection for static IP customers
     */
    static detectTimeoutIssues(): Promise<void>;
    /**
     * Detect degraded performance issues
     */
    static detectDegradedPerformance(): Promise<void>;
    /**
     * Get parent device ID based on network topology
     */
    static getParentDeviceId(deviceId: number): Promise<number | null>;
    /**
     * Smarter device check with retries
     */
    static checkDeviceStatusSmarter(deviceId: number): Promise<DeviceStatus>;
    /**
     * Check for auto-outage jobs
     */
    static checkAutoOutageJobs(): Promise<void>;
}
