...
class GeminiService {
     ...
     */
    static async analyzePaymentProof(imageBuffer, expectedAmount, expectedBank, customerName, invoiceNumber) {
        try {
     ...
     */
    static buildAnalysisPrompt(expectedAmount, expectedBank, customerName, invoiceNumber) {
        // Use comprehensive fraud detection prompt
        return FraudDetectionPrompts_1.FraudDetectionPrompts.getPaymentProofVerificationPrompt(expectedAmount, expectedBank, customerName, invoiceNumber);
    }
    /**
