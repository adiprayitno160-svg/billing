...
exports.TechnicianAttendanceService = void 0;
const pool_1 = require("../../db/pool");
class TechnicianAttendanceService {
    // Ensure table exists
    ...
    // Check In
    static async checkIn(technicianId, wage) {
    ...
    static async getMonthlyReport(technicianId, month, year) {
        await this.ensureTable();
        // Get attendance
        const [attendance] = await pool_1.databasePool.query(`
...
exports.TechnicianAttendanceService = TechnicianAttendanceService;
//# sourceMappingURL=TechnicianAttendanceService.js.map