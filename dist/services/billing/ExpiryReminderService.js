...
exports.ExpiryReminderService = void 0;
...
class ExpiryReminderService {
    ...
    static async sendH3Reminders() {
        try {
            ...
            const [customers] = await pool_1.databasePool.query(`SELECT c.* 
                ...
                AND en.id IS NULL`, [targetDateStr]);
     ...
     */
    static async sendReminder(customer, notificationType) {
        try {
            ...
            // Log notification
            await pool_1.databasePool.query(`INSERT INTO expiry_notifications 
    ...
    static async cleanupOldLogs() {
        try {
            const [result] = await pool_1.databasePool.query(`DELETE FROM expiry_notifications WHERE sent_at < DATE_SUB(NOW(), INTERVAL 90 DAY)`);
     ...
     */
    static async getNotificationHistory(customerId, limit = 10) {
        try {
            const [notifications] = await pool_1.databasePool.query(`SELECT * FROM expiry_notifications 
                WHERE customer_id = ? 
...
exports.ExpiryReminderService = ExpiryReminderService;
//# sourceMappingURL=ExpiryReminderService.js.map