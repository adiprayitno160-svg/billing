...
export declare class PaymentService {
     ...
     * Catat pembayaran
     */
    static recordPayment(paymentData: PaymentData, existingConnection?: PoolConnection | Pool): Promise<number>;
    /**
     * Update status pembayaran invoice
     */
    static updateInvoicePaymentStatus(invoiceId: number, existingConnection?: PoolConnection | Pool): Promise<void>;
    /**
