...
exports.PrepaidCleanupService = void 0;
const pool_1 = require("../../db/pool");
const WhatsAppService_1 = require("../whatsapp/WhatsAppService");
class PrepaidCleanupService {
    /**
     * Auto-expire payment requests older than 1 hour
     */
    static async expireOldPaymentRequests() {
        try {
            const [result] = await pool_1.databasePool.query(`UPDATE payment_requests 
                SET status = 'expired' 
    ...
    static async sendPendingPaymentReminders() {
        try {
            ...
            const [requests] = await pool_1.databasePool.query(`SELECT pr.*, c.name, c.phone, pkg.name as package_name
     ...
     */
    static async sendPaymentReminder(request) {
        try {
     ...
     */
    static async deleteOldPaymentRequests() {
        try {
            const [result] = await pool_1.databasePool.query(`DELETE FROM payment_requests 
...
exports.PrepaidCleanupService = PrepaidCleanupService;
//# sourceMappingURL=PrepaidCleanupService.js.map