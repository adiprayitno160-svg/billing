...
exports.PaymentShortageService = void 0;
...
class PaymentShortageService {
     ...
     */
    static async checkAndNotifyShortages(daysThreshold = 14) {
        ...
        try {
            ...
            `;
            const [invoices] = await connection.query(query, [daysThreshold]);
                ...
                try {
                    ...
                    const notificationIds = await UnifiedNotificationService_1.UnifiedNotificationService.queueNotification({
                        ...
                        variables: {
                            ...
                            amount: NotificationTemplateService_1.NotificationTemplateService.formatCurrency(parseFloat(invoice.remaining_amount || 0)),
                            nominal: NotificationTemplateService_1.NotificationTemplateService.formatCurrency(parseFloat(invoice.remaining_amount || 0)),
                            total_amount: NotificationTemplateService_1.NotificationTemplateService.formatCurrency(parseFloat(invoice.total_amount || 0)),
                            paid_amount: NotificationTemplateService_1.NotificationTemplateService.formatCurrency(parseFloat(invoice.paid_amount || 0)),
                            remaining_amount: NotificationTemplateService_1.NotificationTemplateService.formatCurrency(parseFloat(invoice.remaining_amount || 0)),
...
exports.PaymentShortageService = PaymentShortageService;
//# sourceMappingURL=PaymentShortageService.js.map