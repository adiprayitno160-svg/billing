...
3. 🔍 VALIDASI IDENTITAS (SENSITIF):
   - NAMA PENERIMA: HARUS sesuai dengan rekening resmi ("${expectedRecipientName || 'Perusahaan'}"). 
   - **PENGECUALIAN / WHITELIST SAH:** Jika transfer masuk ke rekening atas nama **EVA RESIANA** atau **ELINDA APRILIANI** (beserta variasi ejaannya), itu adalah rekening asli admin/agen kami. ANGGAP SEBAGAI VALID dan jangan me-reject hanya karena berbeda dari nama perusahaan.
...
CONTOH OUTPUT YANG LULUS (BERDASARKAN REFERENSI TRANSAKSI ASLI):
\`\`\`json
{
  "isValid": true,
  "confidence": 98,
  ...
  "extractedData": {
    ...
    "time": "20:13:23",
    "bank": "BANK JATIM",
    "accountNumber": "658801017448536",
    "accountHolder": "ADI PRAYITNO",
    "referenceNumber": "1139",
    "transferMethod": "ATM - TRANSFER ONLINE ANTAR BANK",
    "status": "SUCCESS"
  },
  "validation": {
    "isPaymentProof": true,
  ...
  "reasoning": "Analisis forensik menunjukkan bukti fisik asli dan valid dari struk ATM."
}
\`\`\`
...
//# sourceMappingURL=FraudDetectionPrompts.js.map