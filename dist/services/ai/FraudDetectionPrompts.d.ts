...
export declare class FraudDetectionPrompts {
     ...
     */
    static getPaymentProofVerificationPrompt(expectedAmount?: number, expectedBank?: string, customerName?: string, invoiceNumber?: string, expectedRecipientName?: string, // e.g. "CV. WXYZ" or "SANDXXX"
    isPrepaid?: boolean, currentDate?: string): string;
    /**
