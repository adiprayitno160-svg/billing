...
exports.ArrearsAnalysisPrompts = void 0;
class ArrearsAnalysisPrompts {
    /**
     ...
     */
    static getEarlyWarningPrompt(customer, arrearsStats, historySummary // Ringkasan history 1 tahun terakhir
    ) {
        return `
     ...
     */
    static getMigrationActionPrompt(customer, arrearsStats) {
        return `
...
exports.ArrearsAnalysisPrompts = ArrearsAnalysisPrompts;
//# sourceMappingURL=ArrearsAnalysisPrompts.js.map