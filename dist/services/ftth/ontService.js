...
class OntService {
    ...
    static async getOntById(id) {
        ...
        `;
        const [rows] = await pool_1.databasePool.query(query, [id]);
        return rows[0] || null;
    }
    static async createOnt(data) {
    ...
    static async updateOnt(id, data) {
    ...
    static async deleteOnt(id) {
        const query = 'DELETE FROM network_devices WHERE id = ? AND device_type = "ont"';
        const [result] = await pool_1.databasePool.query(query, [id]);
        return result.affectedRows > 0;
    }
}
exports.OntService = OntService;
//# sourceMappingURL=ontService.js.map