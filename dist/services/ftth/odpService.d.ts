...
export declare function listOdps(odcId?: number, search?: string, limit?: number, offset?: number): Promise<{
    items: any[];
    total: number;
}>;
...
export declare function recalculateOdpUsage(id: number): Promise<void>;
