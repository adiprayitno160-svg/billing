...
exports.TaxCalculationController = void 0;
const TaxCalculationService_1 = __importDefault(require("../../services/billing/TaxCalculationService"));
class TaxCalculationController {
    /**
     * Get all tax calculations with pagination
     */
    async getAllTaxCalculations(req, res) {
        try {
            const page = parseInt(req.query.page) || 1;
            const limit = parseInt(req.query.limit) || 20;
            const transactionType = req.query.type || '';
            const calculations = await TaxCalculationService_1.default.getAllTaxCalculations({ page, limit, transactionType });
            res.json({
                success: true,
                data: calculations
            });
    ...
    async calculateTax(req, res) {
        try {
            ...
            const result = TaxCalculationService_1.default.calculateTax(base_amount, tax_rate);
            res.json({
                success: true,
                data: result
            });
     ...
     */
    async getTaxCalculation(req, res) {
        try {
            ...
            const calculation = await TaxCalculationService_1.default.getTaxCalculation(id, transactionType);
            if (!calculation) {
                res.status(404).json({
                    success: false,
     ...
     */
    async getTaxCalculationsForTransaction(req, res) {
        try {
            ...
            const calculations = await TaxCalculationService_1.default.getTaxCalculationsForTransaction(transactionId);
            res.json({
                success: true,
                data: calculations
            });
    ...
    async getTaxSummary(req, res) {
        try {
            ...
            const summary = await TaxCalculationService_1.default.getTaxSummary(start, end);
            res.json({
                success: true,
                data: summary
            });
    ...
    async calculateInvoiceTax(req, res) {
        try {
            ...
            const result = await TaxCalculationService_1.default.calculateInvoiceTax(invoiceId);
            res.json({
                success: true,
                data: result
            });
     ...
     */
    async processInvoiceTax(req, res) {
        try {
            const invoiceId = parseInt(req.params.invoiceId);
            if (isNaN(invoiceId)) {
                res.status(400).json({
            ...
            const calculation = await TaxCalculationService_1.default.processInvoiceTax(invoiceId);
            res.json({
                success: true,
    ...
    async getMonthlyTaxReport(req, res) {
        try {
            ...
            const report = await TaxCalculationService_1.default.getMonthlyTaxReport(yearNum, monthNum);
            res.json({
                success: true,
                data: report
            });
     ...
     */
    async getTaxCalculationsByType(req, res) {
        try {
            ...
            const calculations = await TaxCalculationService_1.default.getTaxCalculationsByType(transactionType, limit);
            res.json({
                success: true,
                data: calculations
            });
...
exports.TaxCalculationController = TaxCalculationController;
exports.default = new TaxCalculationController();
//# sourceMappingURL=TaxCalculationController.js.map