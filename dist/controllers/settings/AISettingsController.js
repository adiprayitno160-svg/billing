...
class AISettingsController {
    ...
    static async updateSettings(req, res) {
        try {
            ...
            // Update settings
            // Update settings
            await AISettingsService_1.AISettingsService.updateSettings({
    ...
    static async getStatistics(req, res) {
        try {
            const { AdvancedPaymentVerificationService } = await Promise.resolve().then(() => __importStar(require('../../services/ai/AdvancedPaymentVerificationService')));
