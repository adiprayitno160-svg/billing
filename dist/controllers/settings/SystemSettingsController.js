...
class SystemSettingsController {
     ...
     */
    static async sendTestMonthlyReport(req, res) {
        try {
            const { MonthlyReportService } = await Promise.resolve().then(() => __importStar(require('../../services/billing/MonthlyReportService')));
