...
class ReportingController {
    constructor(db) {
        ...
        this.getONTPerformanceReport = async (req, res) => {
            try {
        ...
        this.getBillingAnalyticsReport = async (req, res) => {
            try {
        ...
        this.getPONUtilizationReport = async (req, res) => {
            try {
        ...
        this.getCustomerAnalyticsReport = async (req, res) => {
            try {
