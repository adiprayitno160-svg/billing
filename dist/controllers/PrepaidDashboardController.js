...
exports.PrepaidDashboardController = void 0;
const pool_1 = require("../db/pool");
/**
 * Prepaid Dashboard Controller
 * Handles UI for prepaid customer management
 */
class PrepaidDashboardController {
    /**
     * Show prepaid customers list page
     */
    static async listPrepaidCustomers(req, res) {
        try {
     ...
     */
    static async listPaymentRequests(req, res) {
        try {
            const conn = await pool_1.databasePool.getConnection();
            try {
    ...
    static async getReports(req, res) {
        try {
            ...
            try {
                ...
                if (period === 'today')
                    dateCondition = "DATE(pt.created_at) = CURDATE()";
                else if (period === 'week')
                    dateCondition = "pt.created_at >= DATE_SUB(NOW(), INTERVAL 1 WEEK)";
                // Get revenue statistics
                const [revenueStatsRows] = await conn.query(`
                    SELECT 
...
exports.PrepaidDashboardController = PrepaidDashboardController;
//# sourceMappingURL=PrepaidDashboardController.js.map