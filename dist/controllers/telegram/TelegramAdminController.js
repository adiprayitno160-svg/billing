...
const TelegramAdminService_1 = __importDefault(require("../../services/telegram/TelegramAdminService"));
...
class TelegramAdminController {
    ...
    async dashboard(req, res) {
        try {
            // Get bot info
            const botInfo = TelegramAdminService_1.default.getBotInfo();
            ...
            const [todayStats] = await pool_1.default.query(`
                SELECT 
                    total_messages,
                    total_commands,
                    total_notifications,
            ...
            const [recentChats] = await pool_1.default.query(`
                SELECT 
                    tcl.id,
            ...
            const [recentNotifications] = await pool_1.default.query(`
                SELECT 
                    id,
                    notification_type,
                    priority,
    ...
    async getStatistics(req, res) {
        try {
            ...
            const stats = await TelegramAdminService_1.default.getBotStatistics(from, to);
            res.json({
                success: true,
                data: stats
            });
    ...
    async createInviteCode(req, res) {
        try {
            ...
            const inviteCode = await TelegramAdminService_1.default.createInviteCode(role, areas, expiry);
            res.json({
                success: true,
                data: {
                    inviteCode,
    ...
    async sendNotification(req, res) {
        try {
            ...
            const result = await TelegramAdminService_1.default.sendNotification({
                type,
                priority,
                title,
                message,
    ...
    async getChatLogs(req, res) {
        try {
            ...
            const [logs] = await pool_1.default.query(query, params);
            res.json({
                success: true,
                data: logs
            });
    ...
    async getNotifications(req, res) {
        try {
            ...
            params.push(parseInt(limit));
            const [notifications] = await pool_1.default.query(query, params);
            res.json({
                success: true,
                data: notifications
            });
     ...
     */
    async getIncidentAssignments(req, res) {
        try {
            ...
            params.push(parseInt(limit));
            const [assignments] = await pool_1.default.query(query, params);
            res.json({
                success: true,
                data: assignments
            });
    ...
    async testSendMessage(req, res) {
        try {
            ...
            await TelegramAdminService_1.default.sendNotification({
                type: 'custom',
                priority: 'low',
                title: 'Test Message',
                message: message,
...
exports.default = new TelegramAdminController();
//# sourceMappingURL=TelegramAdminController.js.map