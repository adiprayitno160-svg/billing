...
async function getDashboard(req, res) {
    ...
    const [activeCustomersP, totalCustomersP, inactiveCustomersP, suspendedCustomersP, pppoeCustomersP, staticIpCustomersP, pppoePackagesP, pppoeProfilesP, newRequests7dP, recentRequestsP, chartRawP, oltCountP, odcCountP, odpCountP, mtSettingsP, troubleCustomersP, latePaymentHighRiskP, latePaymentWarning4P] = await Promise.all([
        ...
        pool_1.databasePool.query("SELECT COUNT(*) AS cnt FROM customers WHERE status='suspended'"),
        pool_1.databasePool.query("SELECT COUNT(*) AS cnt FROM customers WHERE connection_type='pppoe'"),
        pool_1.databasePool.query("SELECT COUNT(*) AS cnt FROM customers WHERE connection_type='static_ip'"),
