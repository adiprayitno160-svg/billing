...
exports.CustomerIdGenerator = void 0;
class CustomerIdGenerator {
     ...
     * @returns string - ID Pelanggan dalam format YYYYMMDDHHMMSS
     */
    static generateCustomerIdFromDate(date) {
     ...
     */
    static generateCustomerIdWithPrefix(prefix = '') {
     ...
     */
    static isValidCustomerIdFormat(customerId) {
     ...
     */
    static parseCustomerIdDate(customerId) {
...
exports.CustomerIdGenerator = CustomerIdGenerator;
