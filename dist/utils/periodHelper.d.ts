 ...
 */
export declare function formatPeriodToMonth(period: string, dueDate?: Date | string | null): string;
/**
 ...
 */
export declare function getNextPeriod(currentPeriod: string): string;
