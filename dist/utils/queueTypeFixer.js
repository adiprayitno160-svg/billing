...
exports.fixQueueType = fixQueueType;
exports.fixQueueConfig = fixQueueConfig;
// Mapping of problematic queue types to safe alternatives
const QUEUE_TYPE_FIXES = {
 ...
 */
function fixQueueType(queueType) {
 ...
 */
function fixQueueConfig(config) {
...
//# sourceMappingURL=queueTypeFixer.js.map